...
public class Unmarshalling {
	...
	public static void main(String[] args) {
		...
		try {
			...
			JSONObject studentJsonOnj = (JSONObject) parser.parse(in);
			in.close();
			
			//Obtain the student properties from the JSONObject
			Number id = (Number) studentJsonOnj.get("ID");
			System.out.println("ID: " + id);
			String name = (String) studentJsonOnj.get("name");
			System.out.println("Name:" + name);
			Boolean isEnrolled = (Boolean) studentJsonOnj.get("isEnrolled");
			System.out.println("Is enrolled: " + isEnrolled);

			//Access the subjects array
			JSONArray subjects = (JSONArray) studentJsonOnj.get("subjects");
